...
//        if (entityClass == null) setAutoClass();
    ...
    sqlQuery = FiQueryUtils.fhrFixAndDeActivateOptParams(sqlQuery);
  ...
  private String convertSqlAndMapToMultiParam(String sqlQuery, Map<String, Object> mapBind) {
    ...
    for (Map.Entry<String, List> entry : mapParamMulti.entrySet()) {
      ...
      sqlQuery = FiQueryUtils.convertSqlForMultiParamByTemplate2(sqlQuery, entry.getKey(), entry.getValue().size());
  ...
  public List<EntClazz> jdSelectListBindEntityRaw(String sqlQuery, EntClazz bindEntity) {
    ...
    try {
      result = jdbi.withHandle(handle -> {
        return handle.select(FiQueryUtils.stoj(sqlQuery))
            .bindBean(bindEntity)
            .mapToBean(getEntityClass())
            .list();
      });
  ...
  public Fdr<List<EntClazz>> jdSelectAllDtoByWhere1(EntClazz entity) {
    ...
    try {
      result = getJdbi().withHandle(handle -> {
        return handle.select(FiQueryUtils.stoj(FiQugen.selectDtoFieldsWithWhere1(getEntityClass())))
            .bindBean(entity)
            .mapToBean(getEntityClass())
            .list();
      });
  ...
  public Fdr<List<EntClazz>> jdSelectAllDtoByFirmFieldsBindMap(Fkb fiKeyBean) {
  ...
  public Optional<Integer> jdSelectCountByAllFields(EntClazz entity) {
    ...
    try {
      result = jdbi.withHandle(handle -> {
        return handle.select(FiQueryUtils.stoj(FiQugen.selectQueryCountWherAllFields(getEntityClass(), entity)))
            .bindBean(entity)
            .mapTo(Integer.class)
            .findFirst();
      });
  ...
  public Fdr<Optional<Integer>> jdSelectCountByCandId1First(Object candId1Value) {
    ...
    Fkb map = Fkb.bui().buiPut(candId1First, candId1Value);
...
//		String candId1First = FiQueryGenerator.getCandId1FirstField(getEntityClass());
  ...
  public Fdr<Optional<Integer>> jdSelectSingleIntOptBindMapWithDeAct(String sqlQuery, Fkb map) {

    Fdr<Optional<Integer>> fdr = new Fdr<>();

    try {
      Optional<Integer> result = getJdbi().withHandle(handle -> {
        return handle.select(FiQueryUtils.fimSqlQueryWithDeActType1(sqlQuery))
            .bindMap(map)
            .mapTo(Integer.class)
            .findFirst();
      });
  ...
  public Fdr jdDeleteByCandId2IntList(List<Integer> listData) {
    ...
    String dbFieldName = FiReflectClass.getListFieldsCandId2(getEntityClass()).get(0).getFcTxDbField();

    Fkb fiKeyBean = Fkb.bui().buiPut(dbFieldName, listData);
...
//		Loghelper.get(getClass()).debug(FiConsole.logMain(fiMapParams));
  ...
  public Fdr jdUpdateBatchWitTrans(List<String> queryList, Fkb mapParams) {
    ...
    try {
      getJdbi().useTransaction(handle -> {
        ...
        for (String query : queryList) {
          if (FiString.isEmpty(query.trim())) continue;
          Integer rowAffected = handle.createUpdate(FiQueryUtils.stoj(query))
  ...
  @Deprecated
  @FiDraft
  public Fdr jdUpdateBatchAsScriptWitTrans(String query, Fkb fiKeyBean) {
    ...
    try {
      getJdbi().useTransaction(handle -> {
        int[] rowAffected = handle.createScript(FiQueryUtils.stoj(query)).bindMap(fiKeyBean).execute();
  ...
  public Fdr<Optional<EntClazz>> jdSelectEntityOptById(Integer id) {
    ...
    Fkb fiKeyBean = Fkb.bui().buiPut(idField, id);
  ...
  public Fdr<Optional<EntClazz>> jdSelectEntityOptByStringCandId1(String txKod) {
    ...
    Fkb fiKeyBean = Fkb.bui().buiPut(txFieldName, txKod);
    return jdSelectEntityOptBindMap(sql, fiKeyBean);
  }
  ...
  public Fdr<Optional<EntClazz>> jdSelectDtoEntityByStrCandId1(String txValue) {
    ...
    Fkb fiKeyBean = Fkb.bui().buiPut(fiQuery.getTxCandIdFieldName(), txValue);
  ...
  public List<EntClazz> jdSelectListDtoFieldsBySeperatedFieldRaw(Fkb fiKeyBean) {
  ...
  public Fdr<List<EntClazz>> jdSelect1ListByCandId(Fkb fiKeyBean) {
  ...
  /**
   * Entity insert sorgusu hazırlar ve çalıştırır
   *
   * @param entity
   * @param boIncludeIdFields sorguya id alanların dahil edilip edilmeyeceği
   * @return
   */
    ...
    try {
      rowCountUpdate = jdbi.withHandle(handle -> {
        ...
        if (FiBool.isTrue(boIncludeIdFields)) {
          sql = FiQueryUtils.stoj(FiQugen.insertQueryWithId(getEntityClass()));
        } else {
          sql = FiQueryUtils.stoj(FiQugen.insertQueryWoutId(getEntityClass()));
        }
  ...
  public Fdr jdInsertQueryBindEntityMain(String sqlInsert, EntClazz entity) {
    ...
    try {
      Integer rowCountUpdate = getJdbi().withHandle(handle -> {
        return handle.createUpdate(FiQueryUtils.stoj(sqlInsert))
            .bindBean(entity)
            .execute(); // returns row count updated
      });
      fdr.setFdBoResult(true);
  ...
  public Fdr jdhInsertQueryBindEntity(String sqlInsert, EntClazz entity, Handle handle) {
    ...
    try {
      Integer rowCountUpdate = handle.createUpdate(FiQueryUtils.stoj(sqlInsert))
          .bindBean(entity)
          .execute(); // returns row count updated
      ...
      boResult = jdbi.inTransaction(handle -> {
        ...
        try {
          ...
          listEntity.forEach(ent -> {
            handle.createUpdate(FiQueryUtils.stoj(FiQugen.insertQueryWoutId(getEntityClass())))
                .bindBean(ent)
                .execute(); // returns row count updated
  ...
  public Fdr jdUpdateBindMapAndEntity(String updateQuery, EntClazz bindEntity, Fkb fiKeyBean) {
  ...
  public Fdr jdUpdateBindObjectMain(String updateQuery, Object bindEntity) {
    ...
    try {
      Integer rowCountUpdate = jdbi.withHandle(handle -> {
        return handle.createUpdate(FiQueryUtils.stoj(updateQuery))
            .bindBean(bindEntity)
            .execute(); // returns row count updated
      });
   ...
   * @return
   */
  public Fdr jdUpdateBindMapAndObjectMain(String updateQuery, Object bindEntity, Fkb fiKeyBean) {
  ...
  public Fdr jdDeleteBindObjectMain(String deleteQuery, Object bindEntity) {
    ...
    try {
      Integer rowsAffected = jdbi.withHandle(handle -> {
        return handle.createUpdate(FiQueryUtils.stoj(deleteQuery))
            .bindBean(bindEntity)
            .execute(); // returns row count updated
      });
  ...
  public Fdr jdUpdateBindMapMain(String updateQuery, Map<String, Object> fiMapParams) {
    ...
    try {
      Integer rowCountUpdate = jdbi.withHandle(handle -> {
        return handle.createUpdate(FiQueryUtils.stojExcludable1(updateQuery))
            .bindMap(fiMapParams)
            .execute(); // returns row count updated
      });
  ...
  public Fdr jdInsertBindMapMain(String insertQuery, Map<String, Object> mapParams) {
    ...
    try {
      Integer rowCountUpdate = jdbi.withHandle(handle -> {
        return handle.createUpdate(FiQueryUtils.stojExcludable1(insertQuery))
            .bindMap(mapParams)
            .execute(); // returns row count updated
      });
      //Loghelperr.getInstance(getClass()).debug("Row Count Update:"+rowCountUpdate);
  ...
  public Fdr jdhUpdateBindMap(String updateQuery, Map<String, Object> fiMapParams, Handle handle) {
    ...
    try {
      Integer rowCountUpdate = handle.createUpdate(FiQueryUtils.stoj(updateQuery))
          .bindMap(fiMapParams)
          .execute(); // returns row count updated
      //Loghelperr.getInstance(getClass()).debug("Row Count Update:"+rowCountUpdate);
      //fiDbResult.setLnSuccessWithUpBoResult(1, rowCountUpdate);
  ...
  public Fdr jdhUpdateBindEntityMain(Handle handle, String updateQuery, EntClazz bindEntity) {
    ...
    try {
      int rowsAffected = handle.createUpdate(FiQueryUtils.stojExcludable1(updateQuery))
          .bindBean(bindEntity)
          .execute();
  ...
  public Fdr jdhUpdateBindObjectMain(Handle handle, String updateQuery, Object bindEntity) {
    ...
    try {
      int rowsAffected = handle.createUpdate(FiQueryUtils.stoj(updateQuery))
          .bindBean(bindEntity)
          .execute();
  ...
  public Fdr jdUpdateFiColsBindMapByIdFieldInFiCols(List<? extends IFiCol> listFields, Fkb fiKeyBean) {
  ...
  public Fdr jdhUpdateFiColsWhereKeyFiColsBindFkb(Handle handle, Fkb fkbParams) {
  ...
  public Fdr jdUpdateFiColsWhereKeyFiColsBindFkb(Fkb fkbParams) {
   ...
   * @return
   */
  public Fdr jdInsertFkb(Fkb fkbParams) {
    return jdInsertFiColsBindFkb(fkbParams.getListFiColInit(), fkbParams);
  }

  public Fdr jdInsertFiColsBindFkb(List<FiCol> fiColList, Fkb fkbParams) {
  ...
  public Fdr jdUpdateFiColsBindColValueByIdField(List<FiCol> fiColList) {
    ...
    for (IFiCol fiCol : fiColList) {
      fkbParams.put(fiCol.getFcTxFieldName(), fiCol.getColValue());
    }
  ...
  public Fdr jdUpdateQueryBindEntityListMain(List<EntClazz> listEntity, String sqlUpdate
    ...
    try {
      boResultTransaction = jdbi.inTransaction(handle -> {
        ...
        try {
          ...
          listEntity.forEach(ent -> {
            ...
            Integer rowsAffectedUpdate = handle.createUpdate(FiQueryUtils.stoj(sqlUpdate))
                .bindBean(ent)
                .execute(); // returns row count updated
      ...
      fdr.setFdBoResult(boResultTransaction);
    } catch (Exception ex) {
      Loghelper.debugException(getClass(), ex);
      fdr.setBoResult(false, ex);
      return fdr;
          ...
          listEntity.forEach(ent -> {
            ...
            if (FiBool.isTrue(boIdNull)) {
              ...
              if (FiBool.isTrue(boBindGeneratedKey)) {
                ...
                Optional opId = handle.createUpdate(FiQueryUtils.stoj(FiQugen.insertQueryJParamWoutId(getEntityClass())))
                    .bindBean(ent)
                ...
                handle.createUpdate(FiQueryUtils.stoj(FiQugen.insertQueryJParamWoutId(getEntityClass())))
            ...
            if (FiBool.isFalse(boIdNull)) {
              ...
              handle.createUpdate(FiQueryUtils.stoj(sqlUpdate))
                  .bindBean(ent)
                  .execute(); // returns row count updated
            }
        ...
        try {
          ...
          listEntity.forEach(ent -> {
            ...
            if (true) {
              ...
              String sql = FiQueryUtils.stoj(fnSqlUpdatePerEntity.apply(ent));
      ...
      boResult = jdbi.inTransaction(handle -> {
        ...
        try {
          ...
          listEntity.forEach(ent -> {
            ...
            if (true) {
              //Loghelperr.getInstance(getClass()).debug("Update AddOrUpdate");
              int execute = handle.createUpdate(FiQueryUtils.stoj(sqlUpdate))
                  .bindMap(mapBind)
                  .bindBean(ent)
                  .execute();// returns row count updated
              fdr.appendRowsAffected(execute);
...
//					}
      ...
      boResult = jdbi.inTransaction(handle -> {
        ...
        try {
          ...
          listEntity.forEach(ent -> {
            ...
            if (FiBool.isTrue(boIdNull)) {
              //Loghelperr.getInstance(getClass()).debug("Insert AddOrUpdate");
              handle.createUpdate(FiQueryUtils.stoj(new FiQugen().insertQueryJParamWoutId(getEntityClass())))
                  .bindBean(ent)
                  .execute(); // returns row count updated
            }
            ...
            if (FiBool.isFalse(boIdNull)) {
              //Loghelperr.getInstance(getClass()).debug("Update AddOrUpdate");
              handle.createUpdate(FiQueryUtils.stoj(fnSqlUpdatePerEntity.apply(ent)))
                  .bindBean(ent)
                  .execute(); // returns row count updated
            }
   ...
   * @return
   */
  public Fdr<Optional<Integer>> jdSelectSingleOpInt(String sql, Fkb fiKeyBean) {
   ...
   * @return
   */
  public Fdr<Integer> jdSelectSingleIntOrMi1(String sql, Fkb fiMapParams) {
  ...
  public Fdr<String> jdSelectSingleString(String sql, Fkb fiKeyBean) {
   ...
   * @return
   */
  public Fdr<List<String>> jdSelectCsvStringAsList(String sql, Fkb fiMapParams) {
...
//				}
  ...
  public void jdhrEntityTransactionsForInsertWithScopeId(
    ...
    if (FiBool.isTrue(boBindGeneratedKey)) { // generated key'de alınacak
      ...
      Optional opId = handle.createUpdate(FiQueryUtils.stoj(sql1 + ";SET NOCOUNT ON;" + sql2))
          .bindBean(ent)
          .executeAndReturnGeneratedKeys(idField)
          .mapTo(idClazz)
          .findFirst(); // returns row count updated
      ...
      int execute = handle.createUpdate(FiQueryUtils.stoj(sql1 + "; " + sql2))
          .bindBean(ent)
          .execute();// returns row count updated
  ...
  public Fdr jdhInsertEntityBindKey(Handle handle, EntClazz entity, String idField, Class idClazz) {
    ...
    String insertQuery = FiQueryUtils.stoj(FiQugen.insertQueryWoutId(getEntityClass()));

    //String idField = FiEntity.getListIdFields(getEntityClass()).get(0);
    //Class idClazz = FiReflection.getFieldClassType(getEntityClass(), idField);

    try {
      ResultBearing resultBearing = handle.createUpdate(FiQueryUtils.stoj(insertQuery)) //+ ";SET NOCOUNT ON;"
          .bindBean(entity)
          .executeAndReturnGeneratedKeys(idField);//
  ...
  public Fdr jdhInsertEntityBindKeyV2(Handle handle, EntClazz entity) {
    ...
    try {
      Optional<Map<String, Object>> opId = handle.createUpdate(FiQueryUtils.stoj(insertQuery + ";SET NOCOUNT ON;"))
          .bindBean(entity)
          .executeAndReturnGeneratedKeys(idField)
          .mapToMap()
          .findFirst();
    ...
    try {
      ...
      getJdbi().useTransaction(handle -> {
        ...
        if (FiBool.isTrue(boBindGeneratedKey)) {
          ...
          Optional optId = handle.createUpdate(FiQueryUtils.stoj(sql1) + ";SET NOCOUNT ON;" + sql2)
              .bindBean(ent)
              .executeAndReturnGeneratedKeys(idField)
              .mapTo(idClazz)
              .findFirst();
          ...
          int execute = handle.createUpdate(FiQueryUtils.stoj(sql1 + "; " + sqlUpScope))
              .bindBean(ent)
              .execute();// returns row count updated
          fdrBatch.appendRowsAffected(execute);
  ...
  public Fdr jdhInsertEntityBindKey0(EntClazz ent, Boolean boBindGeneratedKey, Handle handle) {
    ...
    try {
      if (FiBool.isTrue(boBindGeneratedKey)) {
        ...
        Optional opId = handle.createUpdate(FiQueryUtils.stoj(sql1))
            .bindBean(ent)
        ...
        int execute = handle.createUpdate(FiQueryUtils.stoj(sql1))
            .bindBean(ent)
            .execute();// returns row count updated
        fdrMain.appendRowsAffected(execute);
      }
...
//		Loghelper.get(getClass()).debug("Sql:" + sql);
   ...
   * @return
   */
  public Fdr<List<EntClazz>> jdSelectListWitPrep(String sql, Fkb fiKeyBean) {
...
//		Loghelper.get(getClass()).debug("Sql:" + fiQuery.getTxQuery());
   ...
   * @return
   */
  public Fdr<List<EntClazz>> jdSelectListWitConvertMulti(String sql, Fkb fiKeyBean) {
    FiQuery fiQuery = new FiQuery(sql, fiKeyBean);
