 ...
 */
public class FiReflectionMapperUtil {

    //private FiReflectionMapperUtil() {
    ...
    public static List<String> getColumnNamesOrginal(ResultSet rs) throws SQLException {
        ...
        for (int i = 0; i < count; ++i) {
            //FiConsole.printObjectDefiniton(metadata.getTableName(i+1),"Catalog Name");
