...
public class FiNumber {
  ...
  public static Optional<Double> strToDoubleOpt(String sNumber) {
    ...
    try {
      ...
      Loghelper.get(FiNumber.class).error("Hata :" + FiException.exTosMain(e));
  ...
  public static Double formatStringParatutartoDouble(String number) {
    ...
    try {
      ...
      Loghelper.get(FiString.class)
          .info("Double çeviri hata" + FiException.exTosMain(e));
      value = 0.0D;
    }
  ...
  public static int strToIntOr(Object txValue, int orValue) {

    if (FiString.isEmptyToStringWithTrim(txValue)) return orValue;
