...
//		System.out.println(buffer.toString());
  ...
  public static void printMap(Map<String, String> mapData) {
    System.out.println(textFiKeytext(mapData));
  }
  ...
  public static void printMapFi(Fkb mapData) {
    System.out.println(textFkb(mapData));
  }

  public static String textFiMapString(Map<String, String> appMap) {
    return textFiKeytext(appMap);
  }

  public static String textFiKeytext(Map<String, String> appMap) {
  ...
  public static String textFkb(Fkb fkbEntity) {
    StringBuilder sbLog = new StringBuilder("FiKeyBean İçeriği:");
    sbLog.append("\n");
    for (Map.Entry<String, Object> entry : fkbEntity.entrySet()) {
  ...
  public static String textFkbNtn(Fkb fkbVal) {
    StringBuilder sbLog = new StringBuilder("Fkb Content:");
    sbLog.append("\n");
    //Set<Object> visited = new HashSet<>();
    for (Map.Entry<String, Object> entry : fkbVal.entrySet()) {
      ...
      // safeToString ile dairesel referans koruması

    }
    return sbLog.toString();
  }

  // Helper that safely converts common structures to string while protecting from circular references
  private static String safeToString(Object obj, Set<Object> visited) {
    ...
    if (obj instanceof String || obj instanceof Number || obj instanceof Boolean || obj instanceof Character) {
      return FiString.ToStrOrEmpty(obj);
    }
    ...
    try {
      if (obj instanceof Map) {
        ...
        for (Map.Entry<?, ?> e : map.entrySet()) {
          if (!first) sb.append(", ");
          first = false;
          sb.append(String.valueOf(e.getKey())).append("=").append(safeToString(e.getValue(), visited));
        }
        sb.append("}");
        visited.remove(obj);
        return sb.toString();
      ...
      if (obj instanceof Collection) {
        ...
        for (Object item : (Collection) obj) {
          if (!first) sb.append(", ");
          first = false;
          sb.append(safeToString(item, visited));
        }
        sb.append("]");
        visited.remove(obj);
        return sb.toString();
      ...
      // Fallback - try toString but guard by marking visited
      visited.add(obj);
      String s = FiString.ToStrOrEmpty(obj);
      visited.remove(obj);
      return s;
    } catch (Throwable t) {
  ...
  public static String textFkbList(FkbList fkbList) {
    ...
    for (Fkb fiKeyBean : fkbList) {
      sbOutput.append(textFkb(fiKeyBean)).append("\n");
    }
    return sbOutput.toString();
  }

  public static String textFkbListNtn(FkbList fkbList) {
    if (fkbList == null) return "FkbList is null";
    StringBuilder sbOutput = new StringBuilder();
  ...
  public static void logTextFkb(Fkb fkb) {
    Loghelper.get(FiConsole.class).debug(FiConsole.textFkb(fkb));
  }
