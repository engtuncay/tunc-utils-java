...
public class FiCal {
  ...
  /**
   * 2026-01-21T19:19:11.823 şeklinde gelen date stringe 1 milisaniye ekler
   *
   * @param echTxCDate
   * @return
   */
  public static String addOneMiliSecondToDateString(String echTxCDate) {

    if (echTxCDate == null) return null;

    DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss[.SSS]");
    try {
      LocalDateTime localDateTime = LocalDateTime.parse(echTxCDate, formatter);
      LocalDateTime newLocalDateTime = localDateTime.plusNanos(1000000); // 1 milisaniye = 1.000.000 nanosaniye
      String result = newLocalDateTime.format(formatter);
      return result;
    } catch (Exception e) {
      return null;
    }
...
//		return null;
  ...
  public static Long dateDiffxByDay(Date dtX, Date dtY) {
    return dateDiffByDayV2(dtY, dtX);
  }
   ...
   * @return
   */
  public static Long dateDiffByDayV2(Date startDate, Date endDate) {
   ...
   * @return
   */
  public static Boolean dateLessThanByDay(Date date1, Date date2) {
...
//		Loghelper.get(FiCal.class).debug("Days Between:"+ daysBetween);
  ...
  public static Boolean dateGreaterThanByDay(Date date1, Date date2) {
    LocalDate lcDate1 = FiCal.convertLocalDate(date1);
    LocalDate lcDate2 = FiCal.convertLocalDate(date2);
    long daysBetween = ChronoUnit.DAYS.between(lcDate2, lcDate1); // lcDate1-lcDate2 10-15=-5 10-8=+2
    //Loghelper.get(FiCal.class).debug("Days Between:"+ daysBetween);
