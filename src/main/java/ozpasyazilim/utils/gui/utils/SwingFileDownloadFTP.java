...
import ozpasyazilim.utils.gui.components.JFilePicker;
 ...
 *
 */
public class SwingFileDownloadFTP extends JFrame implements PropertyChangeListener {
	...
	private void buttonDownloadActionPerformed(ActionEvent event) {
		...
		DownloadTask task = new DownloadTask(host, port, username, password, downloadPath, saveDir, this);
