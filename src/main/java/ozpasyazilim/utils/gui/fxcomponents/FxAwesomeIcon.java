...
public class FxAwesomeIcon {
	...
	public Icons525View loadIcon525ToFxButton(Icons525 icon525, Integer length, String fillColor, String strokeColor) {
	...
	public Icons525View loadIcon525ToFxButton(Button btnComp, Icons525 icon525, Integer length){
		return loadIcon525ToFxButton(btnComp,icon525,length,null,null);
	}

	public Icons525View loadIcon525ToFxButton(Button btnComp, Icons525 icon525, Integer length, String fillColor, String strokeColor) {
	...
	public Icons525View loadIcon525ToFxLabel(Label label, Icons525 icon525, Integer length, String fillColor, String strokeColor) {
