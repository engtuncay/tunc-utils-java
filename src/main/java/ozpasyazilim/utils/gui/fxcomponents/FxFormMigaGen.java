 ...
 */
public class FxFormMigaGen<EntClazz> extends FxMigPaneGenView<EntClazz> {
    ...
    private Function<FxFormMigaGen, Fdr> fnValidateForm;

    // Metods

    public FxFormMigaGen() {
        super("insets 0");
    }

    public FxFormMigaGen(Class<EntClazz> entityClazz) {
        super("insets 0");
     ...
     */
    public FxFormMigaGen(List<FiCol> listFormElements) {
        super("insets 0");
        this.listFormElements = listFormElements;
    }

    public FxFormMigaGen(List<FiCol> colsForm, FormType formType) {
        super("insets 0");
    ...
    public void bindEntitytoForm(EntClazz entForm) {
...
//    }
    ...
    public Function<FxFormMigaGen, Fdr> getFnValidateForm() {
        return fnValidateForm;
    }

    public void setFnValidateForm(Function<FxFormMigaGen, Fdr> fnValidateForm) {
