...
/**
 * FxFormMigaGen Ayar Alanları direk FxFormMigaGen sınıfında.
 * <p>
 * initCont ile component'ler initialize edilir.
 * <p>
 * ana kullanılacak form componenti !!!
 * <p>
 * Form alanın değerlerinin aktarılacağı veya alınacağı sınıf
 */
public class FxFormFkb extends FxMigPaneGenView {
  ...
  private Object refFormEntity; // 30-10-21 eklendi
  ...
  private Function<FxFormFkb, Fdr> fnValidateForm;
  ...
  public FxFormFkb(Class<Object> entityClazz) {
    super("insets 0");
   ...
   */
  public FxFormFkb(List<FiCol> listFormElements) {
    super("insets 0");
    this.listFormElements = listFormElements;
  }

  public FxFormFkb(List<FiCol> colsForm, FormType formType) {
    super("insets 0");
  ...
  public void initCont() {
    ...
    if (getFormTypeSelectedInit() == FormType.PlainFormV1) {
      ...
      if (getRefFormEntity() != null) {
        FxEditorFactory.updateFiColsCompsWitFormEntityByEditorValue(getListFormElements(), getRefFormEntity());
      }

      if (getRefFormFkb() != null) {
        FxEditorFactory.updateFiColsCompsWitFkbEntityByEditorValue(getListFormElements(), getRefFormFkb());
      }
  ...
  public void bindEntitytoForm(Object entForm) {
    FxEditorFactory.updateFiColsCompsWitFormEntityByEditorValue(getListFormElements(), entForm);
  }
  ...
  public Object bindFormToEntity() {
    if (getEntityClazz() == null) setAutoClass();
    Object formEntity = FxEditorFactory.bindFormToEntityByEditorNode(getListFormElements(), getEntityClazz());
    return formEntity;
  }
...
//    }
  ...
  public void initFormHp1(List<FiCol> listFormElements, FormType formType, Object formEntity) {
  ...
  public void initWitFormConfig(FxFormConfig fxFormConfig) {
    setFxFormConfig(fxFormConfig);
    initCont();
  }

  private void setFxFormConfig(FxFormConfig fxFormConfig) {
  ...
  private void trigEventsAfterFormLoaded() {
    // URFIX getRefFormEntity() degil, dinamik olarak almalı - getFormAsFkb gibi
  ...
  public void setAutoClass() {
    if (getEntityClazz() == null) {
      this.entityClazz = (Class<Object>) ((ParameterizedType) this.getClass().getGenericSuperclass())
  ...
  public void bindEntityToForm(Object formEntity) {
    setRefFormEntity(formEntity);
    FxEditorFactory.updateFiColsCompsWitFormEntityByEditorValue(getListFormElements(), getRefFormEntity());
    trigEventsAfterFormLoaded();
  }

  public Object getRefFormEntity() {
    return refFormEntity;
  }

  public void setRefFormEntity(Object refFormEntity) {
    this.refFormEntity = refFormEntity;
  }

  public void setFormEntityForEdit(Object formEntity) {
...
//    }
  ...
  public Function<FxFormFkb, Fdr> getFnValidateForm() {
    return fnValidateForm;
  }

  public void setFnValidateForm(Function<FxFormFkb, Fdr> fnValidateForm) {
