 ...
 * Constraint Abbr.
 * <p>
 * cc component constraint, cell constraint  (migpane'e add yapılırken verilen constraint)
 * <p>
 * lcg layout-constraint-general,lrc:layout-row-constr., lcc:layout-col-constr.
 * <p>
 * Constraint yardımcı {@link FxMigHp} class ını kulllan
 */
