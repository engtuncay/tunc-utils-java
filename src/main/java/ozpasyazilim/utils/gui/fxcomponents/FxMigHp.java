 ...
 * <p>
 * lcg:layout-constraints-general, lcc:layout-col-constr.,lrc:layout-row-constr. (contructor parametreleri)
 * <p>
 * cc: cell-contraint ise migpane instance'na node eklerken (add ile) verdiğimiz kısıtlar.
 * <p>
 * migpane.addNode(Node node, String cc) metodunda kullanılır.
 * <p>
