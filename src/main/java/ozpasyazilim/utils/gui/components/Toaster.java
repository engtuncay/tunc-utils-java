 ...
 * 
 * Toaster view in windows system follow the taskbar; So if
 * the taskbar is into the bottom the view coming from the bottom
 * and if the taskbar is on the top then the view coming from the top.
 * 
