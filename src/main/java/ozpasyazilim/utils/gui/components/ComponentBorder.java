 ...
 * able to place a child component anywhere in the parentcomp component. In order
 * to prevent the child component from painting over top of the parentcomp
 * component a Border is added to the parentcomp componet such that the insets of
 * the Border will reserve space for the child component to be painted without
 * affecting the parentcomp component.
 */
public class ComponentBorder implements Border {
	...
	/**
	 * Get the gap between the border component and the parentcomp component
	 *
	...
	/**
	 * Set the gap between the border component and the parentcomp component
	 *
	...
	public void install(JComponent parent) {
		...
		//  Add this Border to the parentcomp
		...
		//  Add component to the parentcomp
	 ...
	 * the component to fit completely in the bounds of the parentcomp component.
	 */
	private void adjustBorderInsets() {
		Insets parentInsets = parentcomp.getInsets();

		//  May need to adust the height of the parentcomp component to fit
		//  the component in the Border

		if (edge == Edge.RIGHT || edge == Edge.LEFT) {
			int parentHeight = parentcomp.getPreferredSize().height
				- parentInsets.top
				- parentInsets.bottom;
		...
		//  May need to adust the width of the parentcomp component to fit
		//  the component in the Border

		if (edge == Edge.TOP || edge == Edge.BOTTOM) {
			int parentWidth = parentcomp.getPreferredSize().width
				- parentInsets.left
				- parentInsets.right;
