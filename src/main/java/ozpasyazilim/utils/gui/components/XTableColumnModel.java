 ...
 * that take a parameter <code>onlyVisible</code> which let's you specify 
 * whether you want invisible columns taken into account. 
 * 
...
public class XTableColumnModel extends DefaultTableColumnModel { 
     ...
     */ 
    protected LinkedList allTableColumns = new LinkedList(); 
