...
public class OzPanel extends JXPanel {
	...
	private void openPanelBilgidialog() {
		...
		Platform.runLater(() -> {
			new FxDialogShow().showModalInfoAlertAsyn(getStrpanelbilgi());
		});
	}
...
//		}
	...
	public void showMessageDialog(String message) {
		...
		Platform.runLater(() -> {
			new FxDialogShow().showModalInfoAlertAsyn(message);
		});
	}
	...
	public void showMessageDialogwarning(String message) {
		...
		Platform.runLater(() -> {
			new FxDialogShow().showModalWarningAlert(finalMessage);
		});
	}
